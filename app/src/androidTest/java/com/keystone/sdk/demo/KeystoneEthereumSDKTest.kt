...
class KeystoneEthereumSDKTest {
    ...
    fun parseSignature() {
        val sdk = KeystoneSDK()
        val ur = UR("eth-signature", "a201d82550cbad90e27e774b6b992c7b0dff204d13025841c127cf3bbd7f6e405995797d4d05bb122688598bf98d7c4b2f7813d84735363a5f7347e3c29d83244b00ff62ae0c717c0c4f7aa9de2bf96da29c1f80ac05d2061b".decodeHex())
        val sign = sdk.eth.parseSignature(ur)
    ...
    fun generateSignRequest() {
        ...
        val sdk = KeystoneSDK()
        val ethSignRequest = EthSignRequest(requestId, signData, dataType, chainId, path, xfp, address, origin)
        val res = sdk.eth.generateSignRequest(ethSignRequest)
        assertEquals(
            res.nextPart(),
