...
class KeystoneSDKTest {
    ...
    fun parseExtendedPublicKey() {
        ...
        val hdKey = sdk.parseExtendedPublicKey(ur)
        println(hdKey)
        ...
        val expectedResult = HDKey(
            ...
            "account.standard",
            "44'/60'/0'",
            "xpub6DNZW8rxA28BGjbbjJEHhsAbYYyFpJJWN52biwHvLS1kTeJ2j2xzcf41oTQ7o5h5udaHqb6NLxei5tZ8fbjBziZajSY4TmrPC4ftcK8pLZ3",
        )
    ...
    fun parseMultiPublicKeys() {
        ...
        val multiHdHeys = sdk.parseMultiPublicKeys(ur)
        println(multiHdHeys)
        ...
        val theFirstExpectedHdKey = HDKey(
            ...
            "account.ledger_live",
            "44'/60'/0'/0/0",
            "xpub6FR3GHXGtwxbXPaU74qA1ATwrJ6gcnYhKmeK2DZyJrNJsMQZY3tkw6nTrJNnHhJVgEzc9Twbco7vCdQnw6ZCr2VCFzaQDf3v4nCFAQLQ6nn",
        )
